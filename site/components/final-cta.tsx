      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-background/70 mb-10 text-pretty">
            Install Redirect 360 today and let it work silently in the
            background. Your visitors—and your SEO - will thank you.
          </p>
          <Link
          ...
          >
            <Button
              size="lg"
              variant="secondary"
              className="gap-2 px-8 text-foreground cursor-pointer"
            >
              Install Redirect 360
        ...
        <div
          className={`mt-16 pt-8 border-t border-background/10 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
